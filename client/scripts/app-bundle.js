define('app',['exports', './services/api'], function (exports, _api) {
  'use strict';
...
define('environment',['exports'], function (exports) {
  ...
  exports.default = {
    debug: true,
    testing: true,
    api: 'http://192.168.11.146:9001/api/',
    year: 2016
  };
});
...
define('services/api',['exports', 'aurelia-framework', 'aurelia-fetch-client', '../environment', 'whatwg-fetch'], function (exports, _aureliaFramework, _aureliaFetchClient, _environment) {
	...
	var Api = exports.Api = (_dec = (0, _aureliaFramework.inject)(_environment2.default, _aureliaFetchClient.HttpClient), _dec(_class = function () {
		...
		Api.prototype.getDivisions = function getDivisions() {
			return this.http.fetch('seasons/' + this.year + '/divisions').then(function (response) {
		...
		Api.prototype.getLeaders = function getLeaders() {
			...
			return this.http.fetch('seasons/' + this.year + '/leaders?page=' + page).then(function (response) {
				return response.json();
			}).then(function (data) {
				return data;
			});
		...
		Api.prototype.getGameLogsForPlayer = function getGameLogsForPlayer(playerId) {
			...
			return this.http.fetch('players/' + playerId + '/gamelogs?year=' + year + '&page=' + page).then(function (response) {
				return response.json();
			}).then(function (data) {
				return data;
			});
		...
		Api.prototype.getTeams = function getTeams() {
			...
			return this.http.fetch('seasons/' + this.year + '/teams?page=' + page).then(function (response) {
				return response.json();
			}).then(function (data) {
				return data;
			});
  ...
  var HomeRuns = exports.HomeRuns = (_dec = (0, _aureliaFramework.inject)(_api.Api), _dec(_class = function () {
    ...
    HomeRuns.prototype.loadHistory = function loadHistory(player, gamelogs) {
      ...
      for (var _iterator2 = gamelogs, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        ...
        var gameDate = new _moment2.default(gamelog.GameDate);
        ...
        if (now.diff(gameDate, 'days') <= 7) player.history.hr7 += gamelog.Hr;
        if (now.diff(gameDate, 'days') <= 14) player.history.hr14 += gamelog.Hr;
        if (now.diff(gameDate, 'days') <= 30) player.history.hr30 += gamelog.Hr;
      }
...
define('resources/elements/baseball-card',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
    'use strict';
    ...
    var BaseballCard = exports.BaseballCard = (_class = function BaseballCard() {
        _classCallCheck(this, BaseballCard);

        _initDefineProp(this, 'player', _descriptor, this);
    }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'player', [_aureliaFramework.bindable], {
        enumerable: true,
        initializer: null
    })), _class);
});
