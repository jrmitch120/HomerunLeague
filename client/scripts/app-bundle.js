define('app',['exports', 'aurelia-framework', 'aurelia-event-aggregator', './services/api'], function (exports, _aureliaFramework, _aureliaEventAggregator, _api) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _api.Api), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'welcome'], name: 'welcome', moduleId: 'pages/welcome/index', nav: true, title: 'Welcome' }, { route: 'teams/create', name: 'join', moduleId: 'pages/teams/create', nav: true, title: 'Join League' }, { route: 'leaders', name: 'leaders', moduleId: 'pages/leaders/homeruns', nav: true, title: 'Leaders' }, { route: 'standings', name: 'standings', moduleId: 'pages/standings/list', nav: true, title: 'Standings' }, { route: 'activity', name: 'activity', moduleId: 'pages/activity/activity', nav: true, title: 'Activity' }, { route: 'teams/:id', name: 'team', moduleId: 'pages/teams/details', nav: false, title: 'Team Information' }, { route: 'players/:id', name: 'player', moduleId: 'pages/players/details', nav: false, title: 'Player Infomration' }]);
...
define('services/api',['exports', 'aurelia-framework', 'aurelia-fetch-client', '../environment', 'whatwg-fetch'], function (exports, _aureliaFramework, _aureliaFetchClient, _environment) {
	...
	var Api = exports.Api = (_dec = (0, _aureliaFramework.inject)(_environment2.default, _aureliaFetchClient.HttpClient), _dec(_class = function () {
		...
		Api.prototype.getTeam = function getTeam(teamId) {
...
define('pages/teams/details',['exports', 'aurelia-framework', '../../services/api'], function (exports, _aureliaFramework, _api) {
  'use strict';
  ...
  var Create = exports.Create = (_dec = (0, _aureliaFramework.inject)(_api.Api), _dec(_class = function () {
    ...
    Create.prototype.activate = function activate(params, routeConfig) {
      var _this = this;

      this.routeConfig = routeConfig;

      return this._api.getTeam(params.id).then(function (response) {
        if (response.team) {
          _this.team = response.team;
          _this.routeConfig.navModel.setTitle(_this.team.name);
          console.info(_this.team);
        } else _this.routeConfig.navModel.setTitle('Team Not Found');
      });
    };
